...
Профиль моделей: `cloud`  ·  дата: 2026-09-14 22:26
...
| доказательность | 1.0 |
| обязательные источники названы | 0.765 |
| нет запрещённых утверждений | 1.0 |
| эскалация при расхождении | 0.333 |
| латентность P50, с | 90.6 |
| латентность P95, с | 228.3 |
| стоимость всего, $ | 0.2459 |
...
| A5 | A | Почему заказ Z-1040 запущен, хотя блок не на | CONSTRAINT_EXPLANATION | confirmed | code, nsi, plan, regulations, task | прошёл |
...
| C1 | C | Почему у заказа Z-1061 замечание НСИ по срок | DATA_VALIDATION | confirmed | code, nsi, plan, task | прошёл |
